...
#define FLEXIO_ReSet_PIN               7U                     /* RESET pin */
#define FLEXIO_ReSet_GPIO              GPIO4

#define LCD_Touch_INT_PORT              PORT4
#define LCD_Touch_INT_PIN               6U                     /* INT pin */
#define LCD_Touch_INT_GPIO              GPIO4
...
/* Configure TOUCH_INT pin as GPIO function and outputting high level */
void LCD_Touch_Config_INT_GPIO_Output(void);

/* Configure TOUCH_INT pin as GPIO function and set as input */
void LCD_Touch_Config_INT_GPIO_Input(void);

/* Set TOUCH_INT pin's level */
