...
#define USB_HID_KEYBOARD_INTERFACE_ALTERNATE_COUNT (1U)
#define USB_HID_KEYBOARD_INTERFACE_ALTERNATE_0 (0U)
...
#define USB_COMPOSITE_INTERFACE_COUNT (USB_HID_KEYBOARD_INTERFACE_COUNT)
/*******************************************************************************
 * API
 ******************************************************************************/
