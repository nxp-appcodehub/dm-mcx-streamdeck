...
#define NORMAL_KEYBOARD 0x01U
#define MULTIMEDIA_KEYBOARD 0x02U
...
typedef enum _usb_direction
{
  ...
  kUSB_Direction0_NULL = 10U,
  kUSB_Direction1_NULL = 11U,
  kUSB_Direction2_NULL = 12U,
  kUSB_Direction3_NULL = 13U,
  kUSB_Direction4_NULL = 14U,
  kUSB_Direction5_NULL = 15U,
  kUSB_Direction6_NULL = 16U,
  kUSB_Direction7_NULL = 17U,
  kUSB_Direction8_NULL = 18U,
  kUSB_Direction9_NULL = 19U,
} usb_direction_t;
