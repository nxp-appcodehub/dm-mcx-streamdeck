...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_img_set_src(ui->screen_img_1, &_Fondo_03_alpha_480x320);
	...
	lv_imgbtn_set_src(ui->screen_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_mic_ina_alpha_86x96, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_mic_act_alpha_86x96, NULL);
	lv_obj_add_flag(ui->screen_imgbtn_1, LV_OBJ_FLAG_CHECKABLE);
	...
	lv_obj_set_pos(ui->screen_imgbtn_1, 27, 53);
	lv_obj_set_size(ui->screen_imgbtn_1, 86, 96);
	...
	lv_imgbtn_set_src(ui->screen_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, &_cam1_ina_alpha_86x96, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_cam1_act_alpha_86x96, NULL);
	lv_obj_add_flag(ui->screen_imgbtn_2, LV_OBJ_FLAG_CHECKABLE);
	...
	lv_obj_set_pos(ui->screen_imgbtn_2, 27, 173);
	lv_obj_set_size(ui->screen_imgbtn_2, 86, 96);
	...
	lv_imgbtn_set_src(ui->screen_imgbtn_3, LV_IMGBTN_STATE_RELEASED, NULL, &_live_ina_alpha_86x96, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_3, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_live_act_alpha_86x96, NULL);
	lv_obj_add_flag(ui->screen_imgbtn_3, LV_OBJ_FLAG_CHECKABLE);
	...
	lv_obj_set_pos(ui->screen_imgbtn_3, 140, 53);
	lv_obj_set_size(ui->screen_imgbtn_3, 86, 96);
	...
	lv_imgbtn_set_src(ui->screen_imgbtn_4, LV_IMGBTN_STATE_RELEASED, NULL, &_cam2_ina_alpha_86x96, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_4, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_cam2_act_alpha_86x96, NULL);
	lv_obj_add_flag(ui->screen_imgbtn_4, LV_OBJ_FLAG_CHECKABLE);
	...
	lv_obj_set_pos(ui->screen_imgbtn_4, 140, 173);
	lv_obj_set_size(ui->screen_imgbtn_4, 86, 96);
	...
	lv_imgbtn_set_src(ui->screen_imgbtn_5, LV_IMGBTN_STATE_RELEASED, NULL, &_rec_ina_alpha_86x96, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_5, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_rec_act_alpha_86x96, NULL);
	lv_obj_add_flag(ui->screen_imgbtn_5, LV_OBJ_FLAG_CHECKABLE);
	...
	lv_obj_set_pos(ui->screen_imgbtn_5, 253, 53);
	lv_obj_set_size(ui->screen_imgbtn_5, 86, 96);
	...
	lv_imgbtn_set_src(ui->screen_imgbtn_6, LV_IMGBTN_STATE_RELEASED, NULL, &_cam3_ina_alpha_86x96, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_6, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_cam3_act_alpha_86x96, NULL);
	lv_obj_add_flag(ui->screen_imgbtn_6, LV_OBJ_FLAG_CHECKABLE);
	...
	lv_obj_set_pos(ui->screen_imgbtn_6, 253, 173);
	lv_obj_set_size(ui->screen_imgbtn_6, 86, 96);
	lv_obj_set_scrollbar_mode(ui->screen_imgbtn_6, LV_SCROLLBAR_MODE_OFF);

	//Write style for screen_imgbtn_6, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_img_opa(ui->screen_imgbtn_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_imgbtn_set_src(ui->screen_imgbtn_7, LV_IMGBTN_STATE_RELEASED, NULL, &_vol02_ina_alpha_86x96, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_7, LV_IMGBTN_STATE_PRESSED, NULL, &_vol002_act_alpha_86x96, NULL);
	lv_obj_add_flag(ui->screen_imgbtn_7, LV_OBJ_FLAG_CHECKABLE);
	...
	lv_obj_set_pos(ui->screen_imgbtn_7, 366, 53);
	lv_obj_set_size(ui->screen_imgbtn_7, 86, 96);
	lv_obj_set_scrollbar_mode(ui->screen_imgbtn_7, LV_SCROLLBAR_MODE_OFF);

	//Write style for screen_imgbtn_7, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_img_opa(ui->screen_imgbtn_7, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_imgbtn_set_src(ui->screen_imgbtn_8, LV_IMGBTN_STATE_RELEASED, NULL, &_vol01_ina_alpha_86x96, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_8, LV_IMGBTN_STATE_PRESSED, NULL, &_vol001_act_alpha_86x96, NULL);
	lv_obj_add_flag(ui->screen_imgbtn_8, LV_OBJ_FLAG_CHECKABLE);
	...
	lv_obj_set_pos(ui->screen_imgbtn_8, 366, 173);
	lv_obj_set_size(ui->screen_imgbtn_8, 86, 96);
	lv_obj_set_scrollbar_mode(ui->screen_imgbtn_8, LV_SCROLLBAR_MODE_OFF);

	//Write style for screen_imgbtn_8, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_img_opa(ui->screen_imgbtn_8, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
